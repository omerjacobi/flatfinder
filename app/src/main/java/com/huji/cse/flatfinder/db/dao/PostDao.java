...
public interface PostDao {
    ...
    @Query("SELECT * FROM post_database WHERE gps_lat BETWEEN :minLat AND :maxLat AND  gps_long" +
            " BETWEEN :minLong AND :maxLong AND number_of_roommates < :maxRoommates AND flat_price < :maxPrice")
